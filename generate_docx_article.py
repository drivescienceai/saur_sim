...
def fig_fire_dynamics() -> io.BytesIO:
    ...
    ax1.set_title("Реальный пожар РВС-20000 (сценарий А)", fontsize=FONT_AXIS+1)
...
def build_document() -> Document:
    ...
    add_para(doc,
        ...
        "часов до нескольких суток (до 81 ч и более). "
    ...
    goals = [
        ...
        "провести верификацию на реальном пожаре РВС-20000;",
    ...
    add_para(doc,
        ...
        "(сценарий А): начальная площадь S₀ = 1250 м², скорость распространения "
    ...
    lims = [
        ...
        "Калибровка параметров проводилась по единственному инциденту (крупный РВС, сценарий А); необходима валидация на 3–5 независимых инцидентах.",
    ...
    refs = [
        ...
        "Отчёт об оперативных действиях при тушении пожара на нефтеперевалочной базе, 2022. — Архив ГУ МЧС.",
