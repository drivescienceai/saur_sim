...
#     Применяются в расчётах ПТП (Серпухов, 2015)
# ══════════════════════════════════════════════════════════════════════════════
...
# Оборудование, применявшееся на пожаре РВС №9, г. Туапсе 14-17.03.2025
...
FOAM_INTENSITY_NORMS: Dict[str, float] = {
    "бензин":          0.065,  # прямогонный бензин (применимо к РВС №9 Туапсе)
    "нефть":           0.060,
    "дизель":          0.048,
    "мазут":           0.060,
...
def foam_attack_feasibility(
    ...
    Физическая модель (ГОСТ Р 51043-2002 + СП 155.13130.2014):
      ...
      Это объясняет реальные события Туапсе 14–17.03.2025:
...
# ══════════════════════════════════════════════════════════════════════════════
# 6. ПАРАМЕТРЫ РВС №9, г. ТУАПСЕ (объект моделирования)
# ══════════════════════════════════════════════════════════════════════════════
...
# Реальные параметры РВС с объекта ООО «РН-Морской терминал Туапсе»
RVS_9 = RVSParams(
    designation="РВС №9",
    volume_m3=20_000,
...
RVS_1000_SERP = RVSParams(
    designation="РВС №13–17 (Рос-Трейд)",
    volume_m3=1_000,
