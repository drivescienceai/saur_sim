...
Curriculum learning:
  Фаза 1 (200 эп.)  — РВС средний ранг 2              → базовая тактика
  Фаза 2 (300 эп.)  — РВС средний + РВС крупный 50/50 → обобщение
  Фаза 3 (500 эп.)  — РВС крупный ранг 4              → сложный сценарий
