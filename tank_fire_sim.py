...
class ModeSelectDialog(tk.Tk):
    ...
    _MODE_HELP: Dict[str, str] = {
        "imitation": (
            ...
            "Пример: выберите сценарий «РВС крупный (Туапсе, 81 ч)», "
        ...
        "irl": (
            ...
            "Пример: из записей ПТП (Туапсе, Серпухов) система извлекает "
        ...
        "rl_hier": (
            ...
            "(Серпухов, 5 ч), затем на смешанном, затем на сложном "
            "(Туапсе, 81 ч). Через 1000 эпизодов иерархический агент "
