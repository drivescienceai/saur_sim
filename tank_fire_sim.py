...
class TankFireApp(tk.Tk):
    ...
    def __init__(self):
        super().__init__()
        self.title("САУР-ПСП — Симуляция управления тушением пожара РВС")
    ...
    def _build_metrics_tab(self, parent):
        ...
        for ax, title in [
            ...
            (self._ax_trunks, "Стволов на охлаждении горящего РВС"),
    ...
    def _draw_map(self):
        ...
        c.create_text(cx17, cy17-8, text="Соседний РВС", fill="white", font=("Arial", 8,"bold"))
        ...
        c.create_oval(cx9-r9, cy9-r9, cx9+r9, cy9+r9,
                      ...
                      width=3, fill="")
        c.create_text(cx9, cy9-6, text="Горящий РВС", fill="white", font=("Arial", 9,"bold"))
        ...
        # ── Стволы охлаждения горящего РВС ───────────────────────────────────
        trunk_positions = [
            (cx9,    cy9+r9+15, "↑Ю"),    # Юг
    ...
    def _update_charts(self):
        ...
        ax.set_title("Стволов на охлаждении горящего РВС", color=P["text"], fontsize=8, pad=3)
