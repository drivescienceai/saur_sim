...
APP_MODES: Dict[str, tuple] = {
    ...
    "rl_hier":   ("🏛  ИЕРАРХИЧЕСКОЕ ОП",           "#1a5276", "#d6eaf8"),
...
class ModeSelectDialog(tk.Tk):
    ...
    _MODE_HELP: Dict[str, str] = {
        ...
        "rl_hier": (
            "ИЕРАРХИЧЕСКОЕ ОБУЧЕНИЕ С ПОДКРЕПЛЕНИЕМ — 3 уровня управления\n\n"
...
class TankFireApp(tk.Tk):
    ...
    _MODE_CATEGORY = {
        ...
        "rl_hier":   "research",    # research UI, фокус на HRL
    ...
    def _build_ui(self):
        ...
        _mode_hints = {
            ...
            "rl_hier":   "Обучение трёхуровневого агента (стратегия → тактика → операции)",
