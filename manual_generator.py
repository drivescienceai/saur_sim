...
def generate_manual(output_path: str = "") -> str:
    ...
    toc_items = [
        ...
        ("4.1.", "Сценарий А — РВС крупный (V=20 000 м³)"),
        ("4.2.", "Сценарий Б — РВС средний (V=2 000 м³, ПТП 2015)"),
    ...
    map_items = [
        ...
        "Текущее действие РТП — информационная строка над открытым водоисточником.",
    ]
    ...
    story.append(Paragraph("4.1. Сценарий А — РВС крупный (V=20 000 м³)", S["h2"]))
    story.append(Paragraph(
        "Основан на реальном протоколе тушения пожара крупного РВС на "
        "нефтеперевалочной базе. Ранг пожара №4 (наивысший). "
    ...
    t1_data = [
        ...
        ["Число ПНС",           "4 (открытый водоисточник, ПАНРК × 2, водоём)"],
    ]
    ...
    story.append(Paragraph("4.2. Сценарий Б — РВС средний (V=2 000 м³, ПТП 2015)", S["h2"]))
    story.append(Paragraph(
        "Основан на плане тушения пожара нефтебазы. "
    ...
    norms_list = [
        ...
        ["ПТП нефтебазы (сценарий Б), 2015",
         "Параметры сценария Б: Q_тр=66 л/с, N_ГПС=3, "
         "N_ств_А=7."],
        ["Протокол тушения крупного РВС (сценарий А)",
         "Параметры сценария А: 81 ч 02 мин, ранг №4, "
    ...
    limits = [
        "Карта пожара отрисована для сценария А (РВС крупный); для сценария Б используется та же схема;",
    ...
    roadmap = [
        "Добавить карту для сценария Б (РВС средний) с правильным масштабом РВС;",
