...
def generate_manual(output_path: str = "") -> str:
    ...
    story.append(Paragraph(
        "Система адаптивного управления ресурсами пожарно-спасательного подразделения",
        S["cover_sub"]
    ))
    ...
    bullets = [
        ...
        "обучения и тестирования RL-агентов управления ресурсами ПСП;",
    ...
    tabs_info = [
        ...
        ("3.9.", "Вкладка «Настройки»",
         ...
         "режим управления (RL обучение / RL эксплуатация / ручное). "
